#!/usr/bin/env python3
"""
Create a valid PDF file for RAG testing
"""

# Create a simple text file that looks like PDF content
...
# Write to a text file (we'll upload this as PDF content)
with open("wolf_ai_catalog.txt", "w", encoding="utf-8") as f:
    f.write(content)

print("✅ Test content created: wolf_ai_catalog.txt")
